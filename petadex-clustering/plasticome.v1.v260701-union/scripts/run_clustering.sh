...
# Dataset: plasticome union v1 v260701  (13 curated seeds + 598 no-seed = 611 records).
#
...
RUN_DIR="/Users/Pixel/Documents/projects/plasticome/petadex-clustering/plasticome.v1.v260701-union"
BIN_DIR="/Users/Pixel/Documents/projects/plasticome/petadex-alignment/petadex-alignment-usearch/bin"
ID=0.90

SEEDS="inputs/putative-curated-seed-set.fasta"                       # 13 curated reference seeds
NOSEED="inputs/plasticome.v1.v260701-union.no-seeds.fasta"           # 598 remaining
...
cat work/seed-centroids.fasta work/denovo-centroids.fasta \
  > results/plasticome.v1.v260701-union.all-centroids.fasta
