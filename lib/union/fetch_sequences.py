...
Writes plasticome.v1-v2-union.tsv in place (aa_sequence filled) and prints a report."""
import csv, os, sys, time, json, urllib.request, urllib.parse

UNION = "plasticome.v1-v2-union.tsv"
...
def main():
    ...
    # persist a small provenance file
    with open("fetched_sequences.json", "w") as f:
